...
% --- SUPERVISÉ ---
\node[box, right=of sup, yshift=-0.8cm] (classif) {Classification};
\node[pinkbox, right=of sup, yshift=0.8cm] (reg) {Régression};

\draw[arrow] (sup) -- (reg);
\draw[arrow] (sup) -- (classif);
...
\node[graybox, right=of disc, yshift=-0.5cm] (RN) {Réseaux de Neurones};
